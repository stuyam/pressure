// Pressure v2.2.0 | Created By Stuart Yamartino | MIT License | 2015 - 2019
...
function (_Adapter) {
  ...
  function AdapterForceTouch(el, block, options) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AdapterForceTouch).call(this, el, block, options));
  }
...
function (_Adapter2) {
  ...
  function Adapter3DTouch(el, block, options) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Adapter3DTouch).call(this, el, block, options));
  }
...
function (_Adapter3) {
  ...
  function AdapterPointer(el, block, options) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AdapterPointer).call(this, el, block, options));
  }
...
var loopPressureElements = function loopPressureElements(selector, closure) {
  ...
  } else if (isElement(selector)) {// if a node list is passed in ex. jQuery $() object
  } else {
